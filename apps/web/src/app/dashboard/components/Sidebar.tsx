    ...
    return (
        <aside className="absolute h-screen">
            <nav className={`fixed z-20 bg-[#F1D9B5] border-r-4 border-[#C9A36A] h-screen transition-all duration-300 ${expanded ? "w-1/8" : "w-1/24"}`}>
                <div className="h-screen flex flex-col justify-between items-left py-2">
                    {/* Top Menu */}
                    <div className="">
                        ...
                        <div className="border-t-2 border-[#C9A36A] mx-2 my-4 py-2 transition-all duration-300">
                            <ul className={`flex flex-col gap-1 text-[#3E3A2D] transition-all duration-300 ${expanded ? "items-baseline" : "items-center"}`}>
                    ...
                    {/* Bottom Menu */}
                    <div className="border-t-2 border-[#C9A36A] mx-2 my-4 py-2 transition-all duration-300">
                        <ul className={`flex flex-col gap-2 text-[#3E3A2D] transition-all duration-300 ${expanded ? "items-baseline" : "items-center"}`}>
